  ...
  <AppLayout>
    <div class="max-w-6xl mx-auto px-4 py-12 bg-gray-200 my-5">
      ...
      <div
        ...
        class="bg-white rounded-2xl shadow-md divide-y divide-gray-100 overflow-hidden"
      >
        <div
        ...
        >
          ...
          <div class="flex items-center mt-5 sm:mt-0 gap-2">
            <button
              ...
              class="px-3 py-1.5 bg-gray-200 hover:bg-gray-300 text-lg font-bold rounded-md disabled:opacity-50"
            >-</button>
      ...
      <div
        v-else
        class="bg-white p-10 text-center rounded-xl shadow-sm text-gray-500 text-xl font-semibold"
      >
        🛒 Your cart is empty!
      </div>
