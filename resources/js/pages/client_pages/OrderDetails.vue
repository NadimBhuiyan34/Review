<template>
    ...
    <AppLayout>
        <div class="mx-auto min-h-screen max-w-[1550px] bg-white p-6 sm:p-10">
           <div class="flex items-center gap-4">
                    <img src="https://img.freepik.com/free-vector/blue-circle-with-white-user_78370-4707.jpg?semt=ais_hybrid&w=740" alt="User avatar" class="h-20 w-20 rounded-full shadow-md ring-2 ring-indigo-500" />
                    <div>
            ...
            <div class="mb-10 grid grid-cols-1 gap-8 md:grid-cols-3">
                ...
                <!-- Price Summary -->
                <section class="relative rounded-2xl border border-gray-200 bg-white p-6 shadow-lg transition duration-300 hover:shadow-2xl sm:p-8">
