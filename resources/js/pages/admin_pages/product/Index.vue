...
<template>
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="p-4 sm:p-6 w-full mx-auto space-y-6 bg-gray-100">
      ...
      <div class="overflow-x-auto rounded-lg shadow bg-white">
        <table class="min-w-full divide-y divide-gray-200 text-sm text-left">
          ...
          <tbody class="divide-y divide-gray-100">
            <tr v-for="product in props.products.data" :key="product.id" class="hover:bg-gray-50 transition">
      ...
      <!-- Pagination -->
      <div v-if="props.products.last_page > 1" class="flex flex-col sm:flex-row justify-between items-center gap-4 pt-4">
